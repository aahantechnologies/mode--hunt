...
define('SUCCESS_URL', 'http://aahantechnologies.com/ModelHunt/php/model/success.php');  //have complete url
define('FAIL_URL', 'http://aahantechnologies.com/ModelHunt/php/model/failure.php');    //add complete url 
