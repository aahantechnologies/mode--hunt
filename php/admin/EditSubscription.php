...
$query="select * from subscription where regid=$regid";
...
<input class="form-control" type="text" Value="<?php echo $row['sub_name'];?>" name="sub_name">
</div>
</div>
...
<div class="col-md-8 col-sm-4 col-xs-12">
<input class="form-control" type="text" Value="<?php echo $row['price'];?>" name="price">
</div>
</div>
...
if(isset($_REQUEST['s']))
{
  ...
  $res=move_uploaded_file($tmpname,$destination);
    extract($_REQUEST);
    $query="update subscription set sub_name='$sub_name',price='$price' where regid=$regid";
 ...
 echo "<script> alert('Record added')</script>";
        echo "<script>window.location='EditSubscription.php'</script>";
