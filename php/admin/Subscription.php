...
<a href="AddSubscription.php"><button type="button" class="btn btn-primary mr-1 mb-2">Add Subscription</button></a>
</div>
</div>
</div>
</div>
...
<td class="td-actions">
<?php 
echo" <a title='update record' href='EditSubscription.php?regid=$row1[0]'><i class='la la-edit edit'></i> </a>";
?>
<?php 
echo"<a title='Delete record' href='Subscription.php?regid=$row1[0]'>  <i class='la la-close delete'></i> </a>";                  
?>
</td>
</tr>
<?php
...
$query="delete from subscription where regid=$regid";
