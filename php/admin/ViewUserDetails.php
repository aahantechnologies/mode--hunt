...
<input class="form-control" type="text" Value="<?php echo $row['first_name'];?>" name="username" readable>
</div>
</div>
...
<div class="col-md-8 col-sm-4 col-xs-12">
<input class="form-control" type="text" Value="<?php echo $row['last_name'];?>" name="username" readable>
</div>
</div>  
...
<div class="col-md-8 col-sm-4 col-xs-12">
<input class="form-control" type="text" Value="<?php echo $row['email'];?>" name="email" readable>
</div>
</div> 
...
<div class="col-md-8 col-sm-4 col-xs-12">
<input class="form-control" type="text" Value="<?php echo $row['password'];?>" name="password" readable>
</div>
</div>        
...
<div class="col-md-8 col-sm-4 col-xs-12">
<input class="form-control" type="text" Value="<?php echo $row['phone_no'];?>" name="contact_no" readable>
</div>
</div>
...
<div class="col-md-8 col-sm-4 col-xs-12">
<input class="form-control" type="text" Value="<?php echo $row['address'];?>" name="contact_no" readable>
</div>
</div>
