...
<td class="td-actions">
<?php 
echo" <a title='update record' href='ViewModel.php?regid=$row1[0]'><i class='la la-edit edit'></i> </a>";
?>
<?php 
echo"<a title='Delete record' href='ModelDetails.php?regid=$row1[0]'>  <i class='la la-close delete'></i> </a>";                  
?>
</td>
</tr>
<?php
