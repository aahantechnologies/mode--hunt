...
<li class="breadcrumb-item active">Service's</li>
</ul>
</div>
</div>
...
<tbody>
<?php
$query1="select * from model_service where email !='admin123@gmail.com'";
...
<td><?php echo $row1['service_price'];?></td>                                                                     
<td class="td-actions">
<?php 
echo" <a title='update record' href='ViewModelServices.php?regid=$row1[0]'><i class='la la-edit edit'></i> </a>";
?>
<?php 
echo"<a title='Delete record' href='ModelServices.php?regid=$row1[0]'>  <i class='la la-close delete'></i> </a>";                  
?>
</td>
</tr>
<?php
...
$query="delete from model_service where regid=$regid";
if(mysqli_query($con,$query))
{
echo "<script>confirm('Are you sure...')</script>";
echo "<script>alert('Record deleted...')</script>";
echo "<script>window.location='ModelServices.php'</script>";
}
else
{
