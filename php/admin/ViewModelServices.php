...
$query="select * from model_service where regid=$regid";
...
<input class="form-control" type="text" Value="<?php echo $row['regid'];?>" name="sub_name">
</div>
</div>
...
<div class="col-md-8 col-sm-4 col-xs-12">
<input class="form-control" type="text" Value="<?php echo $row['services'];?>" name="sub_name">
</div>
</div>
...
<div class="col-md-8 col-sm-4 col-xs-12">
<input class="form-control" type="text" Value="<?php echo $row['service_price'];?>" name="sub_name">
</div>
</div>
