...
<a href="AddModel.php"><button type="button" class="btn btn-primary mr-1 mb-2">Add Model</button></a>
</div>
</div>
</div>
</div>
...
<tbody>
<?php
$query1="select * from model_detail where email='admin@gmail.com'";
...
<td class="td-actions">
<?php 
echo" <a title='update record' href='EditModel.php?regid=$row1[0]'><i class='la la-edit edit'></i> </a>";
?>
<?php 
echo"<a title='Delete record' href='Model.php?regid=$row1[0]'>  <i class='la la-close delete'></i> </a>";                  
?>
</td>
<td class="td-actions">
<?php 
echo" <a title='update record' href='AddSubscription1.php?regid=$row1[0]'><p>subscription</p> </a>";
?>
</td>
</tr>
<?php
