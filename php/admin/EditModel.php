...
<div class="col-md-8 col-sm-4 col-xs-12">
<input class="form-control" type="text" Value="<?php echo $row['height'];?>" name="height">
</div>
</div>
...
<div class="col-md-8 col-sm-4 col-xs-12">
<input class="form-control" type="text" Value="<?php echo $row['bust'];?>" name="bust">
</div>
</div>
...
<div class="col-md-8 col-sm-4 col-xs-12">
<input class="form-control" type="text" Value="<?php echo $row['waist'];?>" name="waist">
</div>
</div>
...
<div class="col-md-8 col-sm-4 col-xs-12">
<input class="form-control" type="text" Value="<?php echo $row['hair'];?>"  name="hair">
</div>
</div>
...
<div class="col-md-8 col-sm-4 col-xs-12">
<input class="form-control" type="text" Value="<?php echo $row['eyes'];?>" name="eyes">
</div>
</div>
...
<div class="col-md-8 col-sm-4 col-xs-12">
<input class="form-control" type="text" Value="<?php echo $row['contact_no'];?>" name="contact_no">
</div>
</div>
...
<div class="col-md-8 col-sm-4 col-xs-12">
<input class="form-control" type="radio" name="gender" value="male" <?php if($row['gender']=="male"){echo "checked";}?>>Male
<input class="form-control" type="radio" name="gender" value="female" <?php if($row['gender']=="female"){echo "checked";}?>>Female
</div>
</div>
...
<div class="col-md-8 col-sm-4 col-xs-12">
<input class="form-control" type="text" Value="<?php echo $row['description'];?>" name="description">
</div>
</div>
<div class="form-group">
...
?>
<option value="<?php echo $row1['services'];?>"><?php echo $row1['services'];?></option>	
<?php
}
?>	
</select>
...
<img src="../<?php echo $row['subimage'];?>" height='50' width='70'/><input type="file" name="subimage" required=""><br>
<img src="../<?php echo $row['subimage1'];?>" height='50' width='70'/><input type="file" name="subimage1" required=""><br>
<img src="../<?php echo $row['subimage2'];?>" height='50' width='70'/><input type="file" name="subimage2" required=""><br>
<img src="../<?php echo $row['subimage3'];?>" height='50' width='70'/><input type="file" name="subimage3" required=""><br>
<img src="../<?php echo $row['subimage4'];?>" height='50' width='70'/><input type="file" name="subimage4" required=""><br>
<img src="../<?php echo $row['subimage5'];?>" height='50' width='70'/><input type="file" name="subimage5" required=""><br>
<img src="../<?php echo $row['subimage6'];?>" height='50' width='70'/><input type="file" name="subimage6" required=""><br>
<img src="../<?php echo $row['subimage7'];?>" height='50' width='70'/><input type="file" name="subimage7" required=""><br>
</div>	
</div>	
...
extract($_REQUEST);
$query="update model_detail set name='$name',height='$height',age='$age',bust='$bust',waist='$waist',hair='$hair',eyes='$eyes',contact_no='$contact_no',image='$destination',subimage='$destination1',subimage1='$destination2',subimage2='$destination3',subimage3='$destination4',subimage4='$destination5',subimage5='$destination6',subimage6='$destination7',subimage7='$destination8',description='$description',country='$country',state='$state',city='$city',gender='$gender',category='$category',email='$email',type='$type',services='$services',service_price='$service_price',password='$password',confirm_password='$confirm_password',subscription='$subscription',subscription_price='$subscription_price',status='$status' where regid=$regid";
...
echo "<script>window.location='EditModel.php'</script>";
}
}
?>
