...
<tbody>
<?php
$query1="select * from model_detail where email='$email'";
...
<td><?php echo $row1['subscription'];?></td> 
<td><?php echo $row1['subscription_price'];?></td> 
<td><img src="../<?php echo $row1['image'];?>" height='70' width='90'/></td>
<td class="td-actions">
<input type="submit" value="Payment" name="pay"/>
</td>
</tr>
<?php
}
...
$row1=mysqli_fetch_array($res1);
  if(mysqli_query($con, $query1)){
	...
	$price=$row1['subscription_price'];
   	   
echo "<script>window.location='http://aahantechnologies.com/ModelHunt/php/admin/ordered.php?email=$email&&contact=$contact&&price=$price'</script>";
}
else
{
