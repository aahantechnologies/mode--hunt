...
<h2 class="page-header-title">Expences</h2>
<div>
<ul class="breadcrumb">
...
<a href="AddExpence.php"><button type="button" class="btn btn-primary mr-1 mb-2">Add Expences</button></a>
</div>
</div>
</div>
</div>
...
<td class="td-actions">
<?php 
echo" <a title='update record' href='EditExpence.php?regid=$row1[0]'><i class='la la-edit edit'></i> </a>";
?>
<?php 
echo"<a title='Delete record' href='Expences.php?regid=$row1[0]'>  <i class='la la-close delete'></i> </a>";                  
?>
</td>
</tr>
<?php
...
$query="delete from expence where regid=$regid";
if(mysqli_query($con,$query))
{
echo "<script>confirm('Are you sure...')</script>";
echo "<script>alert('Record deleted...')</script>";
echo "<script>window.location='Expences.php'</script>";
}
else
{
