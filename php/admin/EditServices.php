...
$query="select * from services where regid=$regid";
...
<input class="form-control" type="text" Value="<?php echo $row['services'];?>"  name="services">
</div>
</div>
...
<center><input type="submit" class="btn btn-success pull-right-container" name="s"  value="Services"></center>
</div> </div> <br/>
<br/>
...
if(isset($_REQUEST['s']))
{
  ...
  $res=move_uploaded_file($tmpname,$destination);
    extract($_REQUEST);
    $query="update services set services='$services' where regid=$regid";
 ...
 echo "<script> alert('Record added')</script>";
        echo "<script>window.location='EditServices.php'</script>";
